 ...
 * - Subtle: Minimal parallax, good for static viewing
 * - Natural: Balanced parallax, recommended for most users
 * - Dramatic: Pronounced parallax, more immersive but can be disorienting
 */
